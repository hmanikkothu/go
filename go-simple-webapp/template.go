...
// parseTemplate applies a given file to the body of the master template.
func parseTemplate(filename string) *appTemplate {
	...
	template.Must(tmpl.New("container").Parse(string(b)))

	return &appTemplate{tmpl.Lookup("master.html")}
}
